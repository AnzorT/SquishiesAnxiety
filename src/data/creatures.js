...
export const CREATURE_VISUALS = {
  ...
  2: { color: '#f97316', accent: '#fb923c', accessory: 'horns', eye: 'round' },
  ...
  6: { color: '#7dd3fc', accent: '#f0f9ff', accessory: 'clouds', eye: 'round' },
  ...
  13: { color: '#6366f1', accent: '#3730a3', accessory: 'horns', eye: 'round' },
